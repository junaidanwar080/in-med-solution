...
<?php include 'navbar.php'; ?>
  ...
  <div style="margin-left: 400px; margin-right: 400px; margin-top: 20px; border-style: solid; border-width: thin; border-color: #878f99; border-radius: 5px; ">
            <div class="card-header" style="background: #59bd8e;  margin-bottom: 20px; "><h4>Login</h4></div>
